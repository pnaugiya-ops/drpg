    ...
    if m == "Health Tracker":
        if st.session_state.stat == "Pregnant":
            ...
            weeks_info = {
                ...
                12: "🍋 **Week 12:** End of 1st Trimester. Organs formed.",
                20: "🍌 **Week 20:** Halfway point! You can feel movements.",
                28: "🍆 **Week 28:** 3rd Trimester begins.",
                36: "🍈 **Week 36:** Baby is dropping into pelvis.",
                40: "🍉 **Week 40:** Full term. Monitor for labor."
            }
            st.info(weeks_info.get(wks, "🍉 Your baby is growing beautifully!"))
