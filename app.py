...
if 'availability' not in st.session_state: st.session_state.availability = {"blocked_dates": []}
if 'social_links' not in st.session_state: st.session_state.social_links = {"youtube": "", "instagram": ""}
...
# --- 3. PATIENT PORTAL ---
    ...
    if m == "Health Tracker":
        if st.session_state.stat == "Pregnant":
            ...
            weeks_info = {4: "🌱 Week 4: Implantation.", 12: "🍋 Week 12: End of T1.", 20: "🍌 Week 20: Halfway!", 28: "🍆 Week 28: T3 begins.", 40: "🍉 Week 4
